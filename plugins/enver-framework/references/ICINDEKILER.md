...
| `sunucu-haritasi.json` | ORNEK DOSYA. Kendi sunucularini tanimlayip sunucu-haritasi.json olarak kaydet. Sunucu ve proje haritasi. Hangi sitenin hangi dizinde, hangi veritabani |

...
for b in gorev.py takvim.py teslim.py; do
  ...
  "$PY_KOMUT" -c "import ast;ast.parse(open('$I/$b',encoding='utf-8').read())" 2>/dev/null \
    && kontrol "is/$b sozdizimi gecerli" 0 || kontrol "is/$b sozdizimi gecerli" 1
done

echo ""
echo "--- 2. GOREV TAKIBI (T42) ---"
CLAUDE_PROJECT_DIR="$KUM" "$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Gorev eklenip okunabiliyor" 0 || kontrol "Gorev eklenip okunabiliyor" 1
import sys
...
CLAUDE_PROJECT_DIR="$KUM" "$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Gorevin kaynagi kaydediliyor" 0 || kontrol "Gorevin kaynagi kaydediliyor" 1
import sys
sys.path.insert(0, "plugins/enver-framework/scripts/is")
sys.path.insert(0, "plugins/enver-framework/scripts/ortak")
sys.path.insert(0, "plugins/enver-framework/scripts/hafiza")
...
CLAUDE_PROJECT_DIR="$KUM" "$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Oncelik ve durum siralamasi dogru" 0 || kontrol "Oncelik ve durum siralamasi dogru" 1
import sys
sys.path.insert(0, "plugins/enver-framework/scripts/is")
sys.path.insert(0, "plugins/enver-framework/scripts/ortak")
sys.path.insert(0, "plugins/enver-framework/scripts/hafiza")
...
CLAUDE_PROJECT_DIR="$KUM" "$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Gorev bitirilebiliyor" 0 || kontrol "Gorev bitirilebiliyor" 1
import sys
sys.path.insert(0, "plugins/enver-framework/scripts/is")
sys.path.insert(0, "plugins/enver-framework/scripts/ortak")
sys.path.insert(0, "plugins/enver-framework/scripts/hafiza")
...
CLAUDE_PROJECT_DIR="$KUM" "$PY_KOMUT" "$I/gorev.py" ozet 2>/dev/null | grep -q "GÖREV ÖZETİ" \
  && kontrol "Gorev ozeti uretiliyor" 0 || kontrol "Gorev ozeti uretiliyor" 1

echo ""
echo "--- 3. HIZMET TAKVIMI (T74) ---"
"$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Uyari esikleri dogru hesaplaniyor" 0 || kontrol "Uyari esikleri dogru hesaplaniyor" 1
import sys
...
"$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Bozuk tarih cokme yapmiyor" 0 || kontrol "Bozuk tarih cokme yapmiyor" 1
import sys
sys.path.insert(0, "plugins/enver-framework/scripts/is")
sys.path.insert(0, "plugins/enver-framework/scripts/ortak")
sys.path.insert(0, "plugins/enver-framework/scripts/hafiza")
...
"$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Kayitlar aciliyet sirasinda geliyor" 0 || kontrol "Kayitlar aciliyet sirasinda geliyor" 1
import sys
sys.path.insert(0, "plugins/enver-framework/scripts/is")
sys.path.insert(0, "plugins/enver-framework/scripts/ortak")
sys.path.insert(0, "plugins/enver-framework/scripts/hafiza")
...
"$PY_KOMUT" "$I/takvim.py" liste --sinir 5 > _calisma/tk.txt 2>&1
grep -q "HİZMET TAKVİMİ" _calisma/tk.txt \
  && kontrol "Takvim listelenebiliyor" 0 || kontrol "Takvim listelenebiliyor" 1

"$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Sertifika taramasi takvime beslenebiliyor" 0 || kontrol "Sertifika taramasi takvime beslenebiliyor" 1
import sys
sys.path.insert(0, "plugins/enver-framework/scripts/is")
sys.path.insert(0, "plugins/enver-framework/scripts/ortak")
sys.path.insert(0, "plugins/enver-framework/scripts/hafiza")
...
"$PY_KOMUT" "$I/teslim.py" hazirla --hedef _calisma/teslim-kapi > _calisma/ts.txt 2>&1 \
...
"$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Erisim belgesinde PAROLA YOK" 0 || kontrol "Erisim belgesinde PAROLA YOK" 1
import re
...
"$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Teknik belge parola icermedigini soyluyor" 0 || kontrol "Teknik belge parola icermedigini soyluyor" 1
from pathlib import Path
...
"$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Tutanakta kapsam disi bolumu var" 0 || kontrol "Tutanakta kapsam disi bolumu var" 1
from pathlib import Path
...
"$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Kisisel veri listesinde en az 8 madde var" 0 || kontrol "Kisisel veri listesinde en az 8 madde var" 1
import sys
sys.path.insert(0, "plugins/enver-framework/scripts/is")
sys.path.insert(0, "plugins/enver-framework/scripts/ortak")
sys.path.insert(0, "plugins/enver-framework/scripts/hafiza")
...
"$PY_KOMUT" "$I/teslim.py" kontrol > _calisma/tk2.txt 2>&1
...
CLAUDE_PROJECT_DIR="$KUM" "$PY_KOMUT" - << 'PY' 2>/dev/null && kontrol "Acil gorev varsa teslim kontrolu DURUYOR" 0 || kontrol "Acil gorev varsa teslim kontrolu DURUYOR" 1
